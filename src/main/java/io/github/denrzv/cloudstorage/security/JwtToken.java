package io.github.denrzv.cloudstorage.security;
...
public class JwtToken implements Serializable {
    ...
    private boolean isTokenInvalidated(String token) {
        final Date expiration = getExpirationDateFromToken(token);
        final Date invalidatedDate = invalidatedTokens.get(token);
        return invalidatedDate != null && expiration.before(invalidatedDate);
    }
}
